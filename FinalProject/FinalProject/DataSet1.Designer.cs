...
namespace FinalProject {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UserRow AddUserRow(string Name, string Email, string Username, string Password, int RoleID) {
...
namespace FinalProject.DataSet1TableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([Name], [Email], [Username], [Password], [RoleID]) VALU" +
                "ES (@Name, @Email, @Username, @Password, @RoleID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[User] SET [Name] = @Name, [Email] = @Email, [Username] = @Username," +
                " [Password] = @Password, [RoleID] = @RoleID WHERE (([UserID] = @Original_UserID)" +
                ")";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, Name, Email, Username, Password, RoleID FROM dbo.[User]";
        ...
        public virtual int Insert(string Name, string Email, string Username, string Password, int RoleID) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Email, string Username, string Password, int RoleID, int Original_UserID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
